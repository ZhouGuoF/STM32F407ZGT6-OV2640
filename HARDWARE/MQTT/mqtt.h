...
#define  PRODUCTKEY           "a1W03pjbbdJ"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "LED_CONTROL"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "25d6bb4fbab4c298a170756eaf567a44"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1W03pjbbdJ/LED_CONTROL/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1W03pjbbdJ/LED_CONTROL/thing/event/property/post"    //需要发布的主题     
